...
$.getJSON(url, function(data) {
	...
	console.log(data);
	html += '<div class="weathercontainer" id="nowcontainer"><div id="nowlabel">Now</div><div id="nowcond"><img src="http://l.yimg.com/a/i/us/we/52/'+item.condition.code+'.gif"/>'+item.condition.text+'</div><div id="temp">'+item.condition.temp+'°</div></div>';
